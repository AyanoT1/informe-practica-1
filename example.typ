...
Se discute la metodología para afrontar el problema, el trabajo con el equipo de desarrolladores de la empresa, la propuesta de soluciones y las complicaciones que se tuvo durante el proceso de práctica. El cómo se llegó a completar la refactorización, mejoras al proceso de testeo y building de la aplicación, nuevas interfaces para la aplicación web de la empresa.
...
Durante el transcurso de la práctica pude experimentar lo que es el trabajo en una empresa consolidada y con procesos burocráticos, como lo fue instalar software en el computador empresarial para trabajar. Para esta actividad, se debe iniciar un proceso por la Mesa de Ayuda Integral de empresas LipiGas, dado que nadie tiene permisos de administrador en los computadores de la empresa, entonces, cada vez que se requiere instalar un software hay que sacar un ticket virtual por la plataforma, esperar aprobación y que un técnico se conecte de manera remota al computador para tipear la clave de administrador en el computador. Este proceso hizo que durante mis primeros 3 días de práctica no pudiera hacer nada más que ver por GitHub cómo estaban estructurados los repositorios y leer un poco de documentación.

Gracias a la modalidad híbrida de trabajo pude convivir con el equipo de desarrolladores de manera presencial en una oficina. La costumbre de todas las mañanas era completar la planilla con la planificación y salir a comprar desayuno a un kiosco cercano, tiempos de convivencia que nos acercaron como practicantes al equipo y ayudaba a crear un ambiente de trabajo en equipo grato.

En un principio mi práctica iba a ser de desarrollo FullStack, empezando primero por el frontend, que suele ser más amigable para un principiante y luego pasar a ver algo de backend o AWS. Sin embargo, dado mi rendimiento y todo el trabajo que necesitaba el frontend terminé enfocándome ahí. Dado esto, logré familiarizarme con TypeScript y React de una manera mucho más profunda y así, resolver problemas más complejos de los que podría haber encontrado si le hubiese dedicado menos tiempo. Para el final de mi práctica también descubrí que en realidad, trabajar en el frontend, si bien no lo encontraba malo o aburrido, la mayoría de problemas no son tan complejos en su naturaleza, sino, son más de seguir una estructura predefinida y poder escribir código más rápido. Hubo un momento en que sentí que ya no estaba aprendiendo tanto y me sentí un poco estancado. La solución que encontré a ese problema fue, si bien la solución del problema de la refactorización está definida, sigo teniendo que reescribir todos los componentes de todas formas, y muchos de estos eran muy parecidos, no había mayor dificultad en eso, por lo que debía simplemente reescribir los componentes más rápido, entonces programé mis propios snippets para rellenar el código boilerplate de los componentes. Gracias a eso pude demorar menos en tareas simplemente aburridas en donde no tenía que pensar en lo absoluto, a pasar más tiempo solucionando bugs, mejorando los componentes reutilizables y en general, dedicando más tiempo a pensar en cómo hacer el proyecto mejor en vez de escribir componentes aburridos.

Por otro lado, a ambos practicantes del equipo nos trataron más como desarrolladores comunes que sólo practicantes, todo nuestro trabajo estaba siendo incorporado directamente en la rama de desarrollo, y en un futuro integrado a producción. Por ende, era nuestra responsabilidad testear de manera exhaustiva nuestros desarrollos porque la empresa no contaba con un departamento de QA y testing de software. Además, como desarrolladores, siempre teníamos acceso a un dump de la base de datos relacional del último mes para fines de desarrollo, estos dumps se compartían libremente por el chat de Devs, por lo que cualquiera puede descargar los códigos fuentes y el dump desde su computadora personal. Como dilema ético, es importante reconocer el valor de los datos, el dump contenía información de contacto de todos los clientes de la empresa, diversas mediciones, etc. Como estudiante de Ingeniería y Ciencias de la Universidad de Chile, no descargué el dump de la base de datos en mi computador personal porque no es lo correcto.

Indagando más sobre la ética profesional, mi compromiso con la calidad del trabajo, siempre perseguí la excelencia sobre todos mis desarrollos, que quizás no fueron las óptimas en todas las situaciones, quizás en 2 años la solución óptima sea otra, pero siempre mantuve un estándar alto en todo mi trabajo, lo que fue reconocido por mi supervisor.

En cuanto a cómo ayudó la universidad en el desempeño de mi práctica, 2 ramos son los destacados por sus enseñanzas, CC3002 - Metodologías de Diseño y Programación, donde se aprende a trabajar en proyectos de una escala un poco mayor a la de los cursos anteriores, se hace una breve introducción a cómo trabajar con GIT. Ambas cosas fueron de gran ayuda al llegar a trabajar en un proyecto de casi medio millón de líneas de código de sólo frontend, en donde más de un desarrollador trabaja en el repositorio. Por otro lado, en el curso electivo CC5002 - Desarrollo de Aplicaciones Web se aprende de manera agnóstica a las tecnologías, todas las bases de lo que es el desarrollo de aplicaciones web, que si no fuese por este ramo electivo, probablemente no hubiese conseguido el puesto de practicante en primer lugar. Estos acercamientos a las áreas de trabajo de ciencias de la computación son muy importantes a la hora de buscar práctica profesional.
